#!/usr/bin/bash
sim_dir=/mnt/projects/users/vliu378/project2/results/aorta/aorta_bootstraps_simulations
out_dir=/mnt/projects/users/vliu378/project2/results/aorta/aorta_bootstraps_enrichment
